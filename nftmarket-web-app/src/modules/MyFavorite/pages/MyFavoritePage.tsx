...
import {getFavoriteList} from "../sevices/apis";
...
const MyFavoritePage = () => {
    ...
    useEffect(() => {
        ...
        setLoading(true);
        getFavoriteList(paramRequest).then(rs => {
            setLoading(false);
            if (rs.code != 0) {
                NotificationError('', '');
                setData([]);
    ...
    return (
        <Wrapper>
            <br/>
            <p className="title-page">Danh sách vật phẩm NFT yêu thích của tôi</p>
            <br/>
            <br/>
            <br/>
...
export default connector(MyFavoritePage);